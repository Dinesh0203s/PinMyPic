...
import { Edit, Save, X, Eye, Calendar, MapPin, Lock, Unlock, Camera, Users } from 'lucide-react';
...
export function EditableEventRow({ event, onEventUpdated, onViewEvent }: EditableEventRowProps) {
  ...
  if (isEditing) {
    return (
      <>
        {/* Mobile Edit Form */}
        <TableRow className="md:hidden bg-blue-50">
          <TableCell colSpan={9} className="p-3 sm:p-4">
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-base sm:text-lg font-semibold text-blue-800">Edit Event</h3>
                <Button
                  size="sm"
                  variant="outline"
              ...
              <div className="grid grid-cols-1 gap-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-700 mb-1 block">Privacy</label>
                    <Select 
                ...
                <div>
                  <label className="text-sm font-medium text-gray-700 mb-2 block">Access PINs</label>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="Bride & Groom PIN"
                      className="text-sm w-full"
                    />
                    <Input
                      value={editData.passcode}
                      onChange={(e) => setEditData(prev => ({ ...prev, passcode: e.target.value }))}
        ...
        {/* Desktop Edit Form - Hidden on Mobile */}
        <TableRow className="hidden md:table-row bg-blue-50">
          <TableCell>
            <Input
              value={editData.title}
              onChange={(e) => setEditData(prev => ({ ...prev, title: e.target.value }))}
