  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-20">
        ...
        {/* Booking Form */}
        <section id="booking-form" className="py-8 md:py-16 bg-gradient-to-br from-gray-50 to-purple-50">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <Card className="shadow-2xl border-0">
                <CardHeader className="text-center bg-gradient-to-r from-purple-50 to-pink-50 p-4 md:p-6">
                ...
                <CardContent className="p-4 md:p-6 lg:p-8">
                  <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                      ...
                      <div>
                        ...
                        <div className="flex gap-2">
                          <select
                            ...
                            className="px-2 md:px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent bg-white text-sm w-20 md:w-32"
                          >
                    ...
                    <div className="text-center pt-4 md:pt-6">
                      <Button 
                        type="submit"
                        className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-8 md:px-12 py-3 md:py-4 text-base md:text-lg rounded-full shadow-lg w-full sm:w-auto"
                        disabled={loading}
                      >
