...
if GPU_AVAILABLE:
    ...
    BATCH_SIZE = int(os.getenv("CPU_BATCH_SIZE", "32"))  # Increased batch for better CPU utilization
    MAX_IMAGE_SIZE = int(os.getenv("CPU_MAX_IMAGE_SIZE", "1024"))  # Lower resolution for CPU

MIN_FACE_SIZE = int(os.getenv("MIN_FACE_SIZE", "20"))  # Minimum face size for detection
